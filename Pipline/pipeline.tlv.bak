...
// This is the whole pipeline which is created using other modules. Here at every cycles, according to the program counter, the instructions get executed in a pipeline manner.
//27-04-2021
